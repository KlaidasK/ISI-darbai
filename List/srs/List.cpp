...
int main()
{
	...
	/// ////////////////////////////////////////////////////////////////////////////////
		...
		do {
			...
			grupe.sort(student); // Rikiavimas pagal vidurki
			...
			if (strat == '1') for (auto& i : Kiet) spausd(i, pas2, pas3, out_k); //Atspausdinama kietekai
			else if (strat == '2') for (auto& i : grupe) spausd(i, pas2, pas3, out_k); //Atspausdinama kietekai
	...
	if (pas != '4') {
		...
		grupe.sort(student); // Rikiavimas pagal vardą
